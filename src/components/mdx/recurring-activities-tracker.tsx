    ...
    <div className="space-y-5">
      <div className="grid gap-3 md:grid-cols-3">
        {(["daily", "weekly", "monthly"] as ActivityFrequency[]).map((frequency) => (
          <div key={frequency} className="border border-border bg-card p-4">
            <div className="text-xs uppercase text-muted-foreground">{frequencyLabels[frequency]} resets in</div>
              ...
              return (
                <tr key={activity.id} className="border-t border-border align-top">
                  ...
                  <td className="px-3 py-3 text-center">
                    <span className="inline-flex min-w-8 justify-center bg-muted px-2 py-1 text-xs font-semibold text-foreground">
                      {activity.priority}
                    </span>
                  </td>
                  <td className="max-w-md px-3 py-3 text-muted-foreground">
                    <div className="font-medium text-foreground">Stopping point: {activity.stoppingPoint}</div>

...
<TableScroll>
  <table>
    ...
    <tbody>
      <tr>
        <td><img src="https://runescape.wiki/images/Necromancy_%28ability%29.png?8464e" className="inline h-5 w-5" /> Necromancy (Basic Attack)</td>
        <td>Generates <strong>2 Necrosis</strong> stacks when cast</td>
      </tr>
      <tr>
        <td><img src="https://runescape.wiki/images/Touch_of_Death.png?9bded" className="inline h-5 w-5" /> Touch of Death</td>
        <td>Generates an extra 6% adrenaline for a total of <strong>15%</strong></td>
      </tr>
      <tr>
        <td><img src="https://runescape.wiki/images/Finger_of_Death.png?84e84" className="inline h-5 w-5" /> Finger of Death</td>
        <td>Deals <strong>50% more damage</strong> for a total of <strong>450% average damage</strong></td>
      </tr>
      <tr>
        <td><img src="https://runescape.wiki/images/Death_Skulls.png?8c821" className="inline h-5 w-5" /> Death Skulls</td>
        <td>Reduces the cooldown from <strong>60s</strong> to <strong>10.2s</strong></td>
      </tr>
    </tbody>
  </table>
</TableScroll>

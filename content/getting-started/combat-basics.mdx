...
<InteractiveLegend
  baseImage="https://media.thersguide.com/compressed/abilities/wm1.jpg"
  items={[
    {
      id: "type",
      name: "Type",
      description: "Displays the name and type of ability",
      hoverImage: "https://media.thersguide.com/compressed/abilities/wm2.jpg",
    },
    {
      id: "cooldown",
      name: "Cooldown",
      description: "Displays the ability's cooldown",
      hoverImage: "https://media.thersguide.com/compressed/abilities/wm3.jpg",
    },
    {
      id: "target",
      name: "Target",
      description: "The type of targeting the ability uses",
      hoverImage: "https://media.thersguide.com/compressed/abilities/wm4.jpg",
    },
    {
      id: "tooltip",
      name: "Description",
      description: "Explanation of what the ability does",
      hoverImage: "https://media.thersguide.com/compressed/abilities/wm5.jpg",
    },
    {
      id: "requirements",
      name: "Requirements",
      description: "Requirements to use the ability",
      hoverImage: "https://media.thersguide.com/compressed/abilities/wm6.jpg",
    },
  ]}
/>
...
**Enhanced Ability:** Enhanced abilities are your next step up. They will deal a moderate to large amount of damage and either cost adrenaline to use, or do not generate any adrenaline.
  ...
  <SplitItem width={40}>
    ![Wild Magic Ability Information](https://media.thersguide.com/compressed/abilities/wm2.jpg)
  </SplitItem>
</SplitContent>
...
Remember that RuneScape runs on a 0.6s [tick system](/getting-started/tick-system). This means that all cooldowns will be in increments of **0.6s**, for example, **20.4s**.
  ...
  <SplitItem width={40}>
    ![Wild Magic Cooldown Information](https://media.thersguide.com/compressed/abilities/wm3.jpg)
  </SplitItem>
</SplitContent>
...
**Self-target:** Self-target abilities are cast on your player. These include movement abilities, damage boosting ultimates, and some defensive abilities. Self-target abilities don't require a target and only affect your character.
  ...
  <SplitItem width={40}>
    ![Wild Magic Target Information](https://media.thersguide.com/compressed/abilities/wm4.jpg)
  </SplitItem>
</SplitContent>
...
Under the damage information, the tooltip will include all other relevant information such as extra effects, number of hits, and adrenaline cost.
  ...
  <SplitItem width={40}>
    ![Wild Magic Tooltip Information](https://media.thersguide.com/compressed/abilities/wm5.jpg)
  </SplitItem>
</SplitContent>
...
At the very bottom of the tooltip are any requirements to cast the ability. This is generally a level requirement and an adrenaline requirement, but can include items or effects.
  ...
  <SplitItem width={40}>
    ![Wild Magic Requirements Information](https://media.thersguide.com/compressed/abilities/wm6.jpg)
  </SplitItem>
</SplitContent>
